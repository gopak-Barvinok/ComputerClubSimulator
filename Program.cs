...
namespace ComputerClub
{
    ...
    class ComputerClub
    {
        ...
        public void Work()
        {
            ...
            {
                Client newClient = _clients.Dequeue(); //получаем клиента и выводим из очереди
                Console.WriteLine($"Баланс: ${_money}. Ждём нового клиента.");
                ...
                //Выводит тру или фолс в зависимости от того, возможно ли привести значение к инту
                    ...
                    if(computerNumber >= 0 && computerNumber < _computers.Count)
                    {
                        ...
                        else
                        {
                            if (newClient.CheckSolvency(_computers[computerNumber])) {
                                Console.WriteLine("Клиент, пересчитав все деньги, оплатил и сел за компьютер " + (computerNumber + 1));
